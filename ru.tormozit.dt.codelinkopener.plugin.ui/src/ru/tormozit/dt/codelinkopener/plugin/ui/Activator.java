...
public class Activator
    extends Plugin
{
    public static final String PLUGIN_ID = "ru.tormozit.dt.codelinkopener.plugin.ui"; //$NON-NLS-1$
    private static Activator plugin;

    private BundleContext bundleContext;

    /**
     * Получить экземпляр плагина. Через экземпляр плагина можно получать доступ к разнообразным механизмам Eclipse, таким как:
     * <ul>
...
//		ServiceInitialization.schedule(() -> registrator.activateManagedService(CodeLinkOpenerManager.class));
    }
...
//		registrator.deactivateManagedServices(this);
    ...
    /**
     * Получить объект, создаваемый OSGi Framework, для доступа к разнообразным сервисам, например, по работе с файловыми ресурсами внутри проекта
     *
     * @return объект, создаваемый OSGi Framework, для доступа к разнообразным сервисам, например, по работе с файловыми ресурсами внутри проекта
     */
